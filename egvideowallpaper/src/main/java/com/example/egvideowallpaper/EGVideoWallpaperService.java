...
import static com.example.egvideowallpaper.Constant.ACTION_VOICE_NORMAL;
import static com.example.egvideowallpaper.Constant.ACTION_VOICE_SILENCE;

/**
 * Created by EG on 2017/12/18.
 */

public class EGVideoWallpaperService extends WallpaperService {
    private static final String TAG = EGVideoWallpaperService.class.getName();
...
//        }
        ...
        intent.putExtra(WallpaperManager.EXTRA_LIVE_WALLPAPER_COMPONENT,new ComponentName(context,EGVideoWallpaperService.class));
    ...
    public Engine onCreateEngine() {
        return new EGVideoWallpagerEngine();
    }
    class EGVideoWallpagerEngine extends Engine{
